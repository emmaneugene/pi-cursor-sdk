...
2. Runtime checks:
   ...
   - required `cursor-http1-live` platform lane proves an enabled HTTP/1.1/SSE turn completes and shows `http1`; unit/default live lanes prove disabled statuses omit it
