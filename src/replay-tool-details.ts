import { asRecord, getBoolean, getNumber, getString } from "./record-utils.js";
import { isCursorReplayActivitySourceName, type CursorReplayActivitySourceName } from "./tool-presentation-registry.js";
