...
import { classifyCursorConnectError, isCursorSdkAbortConnectError, isCursorSdkConnectionStalledError } from "./provider-errors.js";
...
// is exactly the single async pipe-write completion frame. Installed 1.0.30 attaches
