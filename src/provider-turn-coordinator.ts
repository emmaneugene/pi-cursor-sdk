...
import { getNormalizedCursorToolName } from "./tool-visibility.js";
import { buildCursorPiToolDisplay } from "./tool-transcript.js";
import { getField } from "./record-utils.js";
import { CursorTurnDisplayRouter } from "./provider-turn-display-router.js";
import { CursorPartialContentEmitter } from "./partial-content-emitter.js";
import { CursorToolLifecycleEmitter } from "./provider-turn-lifecycle-emitter.js";
import { resolveCursorToolCompletion } from "./provider-turn-sdk-normalizer.js";
import {
	CursorShellOutputTracker,
	formatCursorShellOutputProgressText,
	getCursorShellOutputDelta,
	isCursorShellToolCall,
} from "./provider-turn-shell-output.js";
import {
	CursorToolCompletionLedger,
	getToolFingerprint,
} from "./provider-turn-tool-ledger.js";
import { readCursorSdkTurnUsageFromUpdate, type CursorSdkTurnUsage } from "./usage-accounting.js";
...
export class CursorSdkTurnCoordinator {
	...
	discardIncompleteStartedToolCalls(
		...
		for (const [callId, toolCall] of this.ledger.startedToolCallEntries()) {
			...
			recordDiscardedIncompleteStartedToolCall(this.debugRecorder, loadCursorSdkUserConfig(), {
				toolName,
				callId,
