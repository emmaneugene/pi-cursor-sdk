...
/** Provider-facing wrapper; canonical scrubbing lives in shared/sensitive-text.mjs. */
import { scrubSensitiveText as scrubSensitiveTextJs } from "../shared/sensitive-text.mjs";
