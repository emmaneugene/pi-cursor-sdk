...
import { defaultApiKeyFromEnv, parseArgv } from "./lib/cli-args.mjs";
import { scrubSensitiveText } from "../shared/sensitive-text.mjs";
import { createScriptFail } from "./lib/script-fail.mjs";
import { normalizeCursorContextWindowEntries, projectCursorModelCatalog } from "../shared/model-selection-identities.mjs";

const FALLBACK_MODELS_PATH = "src/fallback-models.generated.ts";
...
Usage:
  ...
  node scripts/refresh-model-snapshots.mjs [options]
