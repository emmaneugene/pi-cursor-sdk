...
} from "../src/tool-transcript.js";
import { CursorTurnDisplayRouter } from "../src/provider-turn-display-router.js";
import type { CursorLiveRun } from "../src/live-run-coordinator.js";
import type { CursorSdkEventDebugRecorder } from "../src/sdk-event-debug.js";
import {
...
vi.mock("../src/tool-transcript.js", async (importOriginal) => {
	const actual = await importOriginal<typeof import("../src/tool-transcript.js")>();
