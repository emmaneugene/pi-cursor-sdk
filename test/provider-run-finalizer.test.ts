...
import { buildIncompleteCursorToolRunOutcome } from "../src/incomplete-tool-visibility.js";
import { CursorRunFinalizer } from "../src/provider-run-finalizer.js";
import { CursorSdkTurnCoordinator } from "../src/provider-turn-coordinator.js";
import type { CursorProviderTurnPrepareResult, LiveCursorProviderTurnRuntime } from "../src/provider-turn-types.js";
import { installCursorSdkProcessErrorGuard } from "../src/sdk-process-error-guard.js";
import type { CursorSdkEventDebugSink } from "../src/sdk-event-debug.js";
import type { SessionCursorAgentLease } from "../src/session-agent.js";
import { createCursorLiveRunAccountingState } from "../src/live-run-accounting.js";
import { asMockCursorRun } from "./helpers/provider-harness.js";
...
vi.mock("../src/provider-turn-finalize.js", () => ({
