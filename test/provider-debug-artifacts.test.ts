...
import { CursorSdkEventDebugSink, __testUtils as sdkEventDebugTestUtils } from "../src/sdk-event-debug.js";
...
describe("streamCursor debug artifacts", () => {
	beforeEach(resetCursorProviderTestState);
		...
		it("records continuation drain artifacts on the next turn debug sink", async () => {
			...
			const { __testUtils: scopeTestUtils } = await import("../src/session-scope.js");
