...
import { isUnauthenticatedConnectError } from "../src/provider-errors.js";
import { makeNodeClosedPipeWriteError } from "./helpers/sdk-process-error-fixtures.js";
import {
	__testUtils,
...
} from "../src/sdk-process-error-guard.js";
...
const guardUrl = pathToFileURL(resolve("src/sdk-process-error-guard.ts")).href;
